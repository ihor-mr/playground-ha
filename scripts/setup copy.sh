...
# for i in mysql-slave1 mysql-slave2; do
# # Configure replication on slaves
# echo "Configuring Slave replication ..."
#     docker exec $i mysql -uroot -prootpass123 -e "
#     STOP SLAVE;
#     CHANGE MASTER TO 
...
# docker exec proxysql mysql -h 127.0.0.1 -u admin -padmin --port=6032 -e "
...
# sleep 2
# curl -s "http://orchestrator:3000/api/discover/mysql-slave1/3306" ||
